...
const tabTitles: Record<string, { title: string; subtitle: string }> = {
  estimator: {
    ...
    subtitle: "Calculate total costs for your target program",
  },
  roi: {
    title: "ROI Calculator",
    subtitle: "Understand your return on investment",
  },
  compare: {
    title: "Loan Comparison",
    subtitle: "Compare lenders side by side",
  },
  heatmap: {
    title: "ROI Heatmap",
    subtitle: "Visualize returns by country and field",
  },
  profile: {
    title: "Profile Analyzer",
    subtitle: "Analyze your chances of admission",
  },
  application: {
    title: "Application Builder",
    subtitle: "AI-powered university application generator",
  },
  "loan-app": {
    title: "Loan Application Builder",
    subtitle: "Generate ready-to-submit bank loan applications",
  },
  resume: {
    title: "ATS Resume Builder",
    subtitle: "Create high-scoring ATS-optimized resumes",
  },
  "ask-ai": {
    title: "Ask AI",
  ...
  settings: {
    title: "Settings",
    subtitle: "Manage API keys and local data",
  },
}
