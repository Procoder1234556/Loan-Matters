    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-6 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <Image src={IMAGES.ai} alt="Blog illustration" fill className="object-cover" />
        </div>
      ...
      {featuredBlogs.length > 0 && (
        <section className="px-6 pb-16">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl font-bold text-foreground mb-6 opacity-0 animate-fade-slide-up">
              Featured Articles
            </h2>
            ...
            <Card className="opacity-0 animate-fade-slide-up">
              <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                <div className="relative w-32 h-32 mb-6">
                  <Image src={IMAGES.ai} alt="No blogs" fill className="object-cover opacity-50" />
                </div>
