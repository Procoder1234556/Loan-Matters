...
import { 
  Calculator, TrendingUp, Scale, Grid3X3, MessageSquare, GraduationCap,
  Home, Settings, HelpCircle, UserCheck, BookOpen, FileText, Briefcase, Landmark
} from "lucide-react"
    ...
    <>
      ...
      <aside className="hidden md:flex flex-col w-72 bg-card border-r border-border">
        <div className="flex items-center gap-3 px-6 py-5 border-b border-border">
          ...
          <div>
            <h1 className="text-lg font-bold text-foreground">LoanMatters</h1>
